...
class Config():
    ...
    def __datasetCommonParams(self):
        root_dataset_dir = 'G:/Self-mm/'
        tmp = {
            'mosi':{
                'aligned': {
                    'dataPath': os.path.join(root_dataset_dir, 'I:/mosi/aligned_50.pkl'),
                    'seq_lens': (50, 50, 50),
                    # (text, audio, video)
                ...
                'unaligned': {
                    'dataPath': os.path.join(root_dataset_dir, 'I:/mosi/unaligned_50.pkl'),
                    'seq_lens': (50, 50, 50),
                    # (text, audio, video)
                    'feature_dims': (768, 5, 20),
                    'train_samples': 1284,
            ...
            'mosei':{
                'aligned': {
                    'dataPath': os.path.join(root_dataset_dir, 'I:/mosei/aligned_50.pkl'),
                    'seq_lens': (50, 50, 50),
                    # (text, audio, video)
                ...
                'unaligned': {
                    'dataPath': os.path.join(root_dataset_dir, 'I:/mosei/unaligned_50.pkl'),
                    'seq_lens': (50, 500, 375),
                    # (text, audio, video)
                    'feature_dims': (768, 74, 35),
                    'train_samples': 16326,
            ...
            'sims':{
                'unaligned': {
                    'dataPath': os.path.join(root_dataset_dir, 'I:/sims/unaligned_39.pkl'),
