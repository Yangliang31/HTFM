...
from HTFM import HTFM
from HTFM_TRAIN import HTFM_TRAIN
...
def run(args):
    ...
    htfm = HTFM_TRAIN(args)
    # do train
    htfm.do_train(model, dataloader)
    ...
    if args.tune_mode:
        ...
        results = htfm.do_test(model, dataloader['valid'], mode="VALID")
    else:
        results = htfm.do_test(model, dataloader['test'], mode="TEST")
...
def parse_args():
    ...
    parser.add_argument('--modelName', type=str, default='htfm',
                        help='support htfm')
